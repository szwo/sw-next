    ...
    return (
        <div className="prose prose-sm prose-invert max-w-none">
            ...
            <ul>
                ...
                <li>
                    This allows the user to see and interact with the most essential parts of the page while the rest of
                    the content loads - instead of waiting for the whole page to load before they can interact with
                    anything.
                </li>
