...
export default async function Page({ searchParams }: { searchParams: any }) {
    return (
        <div className="prose prose-sm prose-invert max-w-none">
            ...
            <p>
                The <code>useSearchParams</code> hook returns a read only version of <code>URLSearchParams</code>. You
                can use <code>useRouter&#40;&#41;</code> or <code>&lt;Link&gt;</code> to set new{' '}
                <code>searchParams</code>. After a navigation is performed, the current <code>page.js</code> will
